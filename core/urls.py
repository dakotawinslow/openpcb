...
urlpatterns = [
    ...
    path(
        'projects/<uuid:uuid>/<slug:slug>/edit/',
        views.ProjectUpdateView.as_view(),
        name='project_edit',
    ),
    path(
        'projects/<uuid:uuid>/<slug:slug>/delete/',
    ...
    path(
        ...
        views.photo_set_featured,
        name='photo_set_featured',
    ),
    path(
        'projects/<uuid:uuid>/<slug:slug>/photos/reorder/',
        views.photo_reorder,
        name='photo_reorder',
    ),
